...
Shaders_Simple2D_FragmentIn VS(Shaders_Simple2D_VertexIn input_)
{
    Shaders_Simple2D_FragmentIn output_;
...
void main()
{
    Shaders_Simple2D_VertexIn input_;
    input_.Position = Position;
    input_.TexCoord = TexCoord;
    Shaders_Simple2D_FragmentIn output_ = VS(input_);
