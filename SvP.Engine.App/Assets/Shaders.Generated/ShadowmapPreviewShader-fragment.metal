...
{}
float4 FS(Shaders_ShadowmapPreviewShader_FragmentIn input)
{
...
fragment float4 FS(Shaders_ShadowmapPreviewShader_FragmentIn input [[ stage_in ]], texture2d<float> Tex [[ texture(0) ]], sampler TexSampler [[ sampler(0) ]])
{
