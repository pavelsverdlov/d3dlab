...
vertex Shaders_ShadowmapPreviewShader_FragmentIn VS(Shaders_ShadowmapPreviewShader_VertexIn input [[ stage_in ]], constant float4x4 &Projection [[ buffer(1) ]], constant Veldrid_NeoDemo_Objects_ShadowmapDrawIndexeder_SizeInfo &SizePos [[ buffer(2) ]])
{
