...
namespace D3DLab.Std.Engine.Core.Animation.Formats {
    ...
    /// </summary>
    public static class CMOAnimationLoader {
        /// <summary>
    ...
    /// </summary>
    public class CMOAnimateMeshComponent : GraphicComponent, IAnimateMeshComponent {
        ...
        public struct Vertex {
            ...
            public ColorB Color; //TODO: it can be wrong order of bytes
            public Vector2 UV;
        }
        ...
        public struct Bone {
            ...
            public Matrix4x4 BoneLocalTransform;
        };
    ...
    internal static class BinaryReaderExtensions {
        ...
        public static T ReadStructure<T>(this BinaryReader br) where T : struct {
            return ByteArrayToStructure<T>(br.ReadBytes(Unsafe.SizeOf<T>()));
        }
        ...
        public static T[] ReadStructure<T>(this BinaryReader br, int count) where T : struct {
            ...
            for (var i = 0; i < count; i++)
                result[i] = ByteArrayToStructure<T>(br.ReadBytes(Unsafe.SizeOf<T>()));
