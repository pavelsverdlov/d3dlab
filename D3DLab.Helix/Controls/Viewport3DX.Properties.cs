...
namespace HelixToolkit.Wpf.SharpDX
{
	...
	public partial class Viewport3DX
	{
		...
		private void CopyCamera(RenderContext renderContext)
		{
			if (Camera == null)
			{
			...
			var renderCamera = renderContext.Camera;
			if (renderCamera == null || renderCamera.GetType() != Camera.GetType())
				renderCamera = (Camera)Activator.CreateInstance(Camera.GetType());
			...
			renderContext.Camera = renderCamera;
		}
