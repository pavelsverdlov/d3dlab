...
using HelixToolkit.Wpf.SharpDX.StateMachine;
...
namespace HelixToolkit.Wpf.SharpDX.Controllers {
    public interface IMouse3DController {
        void Initialize(InputController inputController);
    }

    public class InputController : StateControllerBase<InputControllerStateContext, IInputSupport, InputSupportToEvents> {
        IMouse3DController mouse3DController;
        public InputController(IMouse3DController mouse3DController, CameraViewController cameraViewController)
            ...
            this.mouse3DController = mouse3DController;
            this.mouse3DController.Initialize(this);
        }

        public Enum CurrentStateId { get { return CurrentState != null ? CurrentState.Id : null; } }
        ...
        internal bool OnGetRotateCenter(MouseEventArgs ea, out Point3D? point) {
    ...
    public class GetRotateCenterEventArgs : EventArgs {
    ...
    public class GetCustomRotateMarginsEventArgs : EventArgs {
    ...
    public class CancelSwitchToStateEventArgs : EventArgs {
