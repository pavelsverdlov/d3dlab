namespace HelixToolkit.Wpf.SharpDX.Core
{
    ...
    public sealed class Vector3Collection : ObservableList<Vector3>
    {
		...
		public Vector3Collection Copy()
		{
			return new Vector3Collection(this);
		}

		public static Vector3Collection FromArraySafe(Vector3[] list)
		{
			if (list == null)
				return null;
			return FromArray<Vector3Collection>(list);
		}

		new public static Vector3Collection FromArray(Vector3[] list)
		{
