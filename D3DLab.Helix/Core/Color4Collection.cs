namespace HelixToolkit.Wpf.SharpDX.Core
{
    ...
    public sealed class Color4Collection : ObservableList<Color4>
    {
		...
		public Color4Collection Copy()
		{
			return new Color4Collection(this);
		}

		public static Color4Collection FromArraySafe(Color4[] list)
		{
			if (list == null)
				return null;
			return FromArray<Color4Collection>(list);
		}

		new public static Color4Collection FromArray(Color4[] list)
		{
