...
namespace HelixToolkit.Wpf.SharpDX.Helpers
{
    ...
    public static class Viewport3DHelper
    {
        ...
        /// <param name="background">The background.</param>
        /// <param name="m">The oversampling multiplier.</param>
        /// <param name="height">The oversampling multiplier.</param>
        /// <param name="width">The oversampling multiplier.</param>
        /// <returns>A bitmap.</returns>
        public static BitmapSource RenderBitmap(this Viewport3D view, Brush background, int m = 1, double height = 0, double width = 0) {
            ...
            for (int i = 0; i < m; i++)
            {
                for (int j = 0; j < m; j++)
                {
                    ...
                    var partialBitmap = new RenderTargetBitmap((int)acWidth, (int)acHeight, 96, 96, PixelFormats.Pbgra32);
