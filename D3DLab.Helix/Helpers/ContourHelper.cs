...
namespace HelixToolkit.Wpf.SharpDX
{
    ...
    internal class ContourHelper
    {
        ...
        /// The textures.
        /// </summary>
		private readonly Vector2[] textures = new Vector2[3];
        ...
        /// </param>
        public ContourHelper(Vector3 planeOrigin, Vector3 planeNormal, MeshGeometry3D originalMesh, bool hasTextureCoordinates = false)
        {
