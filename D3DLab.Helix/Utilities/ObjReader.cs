...
namespace HelixToolkit.Wpf.SharpDX
{
    ...
    public class ObjReader : IModelReader
    {
        ...
        public ObjReader()
        {
            ...
            this.DefaultColor = global::SharpDX.Color.Gray;
        ...
        /// </summary>
        private IList<Color4> Colors { get; set; }
        ...
        private void AddVertex(string values)
        {
            ...
            if(fields.Count > 4)
            {
                this.Colors.Add(new Color3((float) fields[3], (float) fields[4], (float) fields[5]).ToColor4());
            }
        }
        ...
        public class Group
        {
            ...
            public Material Material{
                ...
                get { return this.materials[this.materials.Count - 1]; }
            }
        ...
        public class MaterialDefinition
        {
            ...
            private Material CreateMaterial(string texturePath){
                ...
                var mat = new PhongMaterial()
                {
                    ...
                    DiffuseMap = (this.DiffuseMap == null) ? null : (!string.IsNullOrEmpty(texturePath)) ? LoadImageWithTexture(path) : LoadImage(path),                    
            ...
            private static BitmapImage LoadImageWithTexture(string path) {
