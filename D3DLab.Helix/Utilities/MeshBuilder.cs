namespace HelixToolkit.Wpf.SharpDX
{
    ...
    public class MeshBuilder
    {
        ...
        public Color4Collection Colors { get { return colors; } }
        ...
        public MeshBuilder(bool generateNormals = true, bool generateTexCoords = true, bool tangentSpace = false)
        {
            ...
            this.colors = new Color4Collection();
            if (generateNormals)
            {
        ...
        public MeshGeometry3D ToMeshGeometry3D()
        {
            ...
            return new MeshGeometry3D()
            {
				...
				Indices = this.triangleIndices.Copy(),
				Normals = (this.HasNormals) ? this.normals.Copy() : null,
				TextureCoordinates = (this.HasTexCoords) ? this.textureCoordinates.Copy() : null,
				Tangents = (this.HasTangents) ? this.tangents.Copy() : null,
				BiTangents = (this.HasTangents) ? this.bitangents.Copy() : null,
                Colors = Colors,
            };
        }
#if Sphere
        ...
        public void Append(MeshGeometry3D mesh)
        {
            ...
            this.Append(mesh.Positions, mesh.Indices, mesh.Normals, mesh.TextureCoordinates, mesh.Colors);
        }

        private void Append(Vector3Collection positionsToAppend, IntCollection triangleIndicesToAppend, Vector3Collection normalsToAppend, Vector2Collection textureCoordinatesToAppend, Color4Collection colorsToAppend) {
        ...
        public void Append(
			...
			IList<Color4> colorsToAppend = null)
        {
            if (positionsToAppend == null)
            {
                throw new ArgumentNullException("positionsToAppend");
